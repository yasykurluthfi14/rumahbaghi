...
<html>
    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="<?php echo site_url('backend/perumahan');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Data</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                            <li class ="active"><a href="<?php echo site_url('backend/backlog');?>" class="waves-effect waves-button"><span class="menu-icon icon-like"></span><p>Backlog</p></a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Add New Backlog</button>
                                    ...
                                    <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->kelurahan;?></td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->id_backlog;?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-userid="<?php echo $row->id_backlog;?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'backend/backlog/insert'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Add New Backllog</h4>
                    </div>
                    ...
                    <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                            <div class="row">
                                ...
                                <tr>
                                    <th>Backlog</th>
                                    <td><input type="text" name="backlog" class="form-control"  required></td>
                                </tr>
        ...
        ?>
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'backend/backlog/update'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalEdit<?php echo $row->id_backlog;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Backlog</h4>
                    </div>
                    <div class="modal-body">
                    ...
                    <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                            <div class="row">
                                ...
                                <tr>
                                    <th>Kelurahan</th>
                                    <td><input type="text" value="<?php echo $row->kelurahan ?>" name="kelurahan" class="form-control"  required></td>
                                ...
                                <tr>
                                    <th>Backlog</th>
                                    <td><input type="text" value="<?php echo $row->backlog ?>" name="backlog" class="form-control"  required></td>
                                </tr>
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="id_backlog" value="<?php echo $row->id_backlog;?>" required>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
       ...
       <!-- Modal hapus-->
        <form id="add-row-form" action="<?php echo base_url().'backend/backlog/delete'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Backlog</h4>
                    </div>
                    <div class="modal-body">
                            <strong>Anda yakin mau menghapus backlog ini?</strong>
                            <div class="form-group">
                                <input type="hidden" id="txt_kode" name="kode" class="form-control" placeholder="ID_Backklog" required>
                            </div>
