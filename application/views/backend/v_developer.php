...
<html>
    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="<?php echo site_url('backend/perumahan');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Data</p><span class="arrow"></span></a>
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/developer');?>" class="waves-effect waves-button"><span class="menu-icon icon-like"></span><p>Developer</p></a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Add New Developer</button>
                                    ...
                                    <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $row->nama_developer;?></td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->id_developer;?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-userid="<?php echo $row->id_developer;?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'backend/developer/insert'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Add New Developer</h4>
                    </div>
                    ...
                    <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                            <div class="row">
                                ...
                                <tr>
                                    <th>Developer</th>
                                    <td><input type="text" name="nama_developer" class="form-control"  required></td>
                                    </div>
                                </tr>
                                <tr>
                                    <th>Telepon</th>
        ...
        ?>
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'backend/developer/update'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalEdit<?php echo $row->id_developer;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                            <div class="row">
                                ...
                                <tr>
                                    <th>Developer</th>
                                    <td><input type="text" value="<?php echo $row->nama_developer ?>" name="nama_developer" class="form-control"  required></td>
                                    </div>
                                </tr>
                                <tr>
                                    <th>Telepon</th>
                                    <td><input type="text" value="<?php echo $row->telepon ?>" name="telepon" class="form-control"  required></td>
                                </tr>
                                <tr>
                                    <th>Alamat</th>
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="id_developer" value="<?php echo $row->id_developer;?>" required>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
       ...
       <!-- Modal hapus-->
        <form id="add-row-form" action="<?php echo base_url().'backend/developer/delete'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Developer</h4>
                    </div>
                    <div class="modal-body">
                            <strong>Anda yakin mau menghapus developer ini?</strong>
