                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap text-center pt-100">
                            <h2 style="font-size:2.5vw; color:white;"> Data Rumah Layak Huni Dan Tidak Layak Huni</h2>
                        </div>
                    </div>
                </div>
            </div>
							...
							<table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
										...
										<?php 
                                            ...
                                            <tr>
												...
												<td ><a href="<?php echo base_url('rtlh/detail_rtlh/').$row->id_rtlh?>" class="btn btn-primary detail"> Detail </a></td>
